...
export const blogArticleDetails = [
  {
    ...
    date: 'March 15, 2026',
    readTime: '6 min read',
    author: 'The IVY Retouching Team',
    intro: [
    ...
    quote: {
      text: 'Our goal is to make people look like the best version of themselves, not someone else entirely.',
    },
    gallery: [homeAboutRight, homeAboutLeft],
    workflow: [
      {
    ...
    proTip: {
      title: 'The 50% Test',
      text: 'After retouching, reduce your adjustment layer opacity to 50%. If the image still looks good, you have done it right. If it looks noticeably worse, you may have gone too far.',
    },
    mistakesIntro: 'Even experienced photographers can fall into these traps:',
    mistakes: [
      {
        title: 'Over-smoothing',
        description:
          'Completely blurred skin that looks like porcelain or plastic.',
      },
      {
        title: 'Removing natural features',
        description:
          "Freckles, laugh lines, and character marks that define someone's face.",
      },
      {
        title: 'Inconsistent lighting',
        description:
          'Creating unnatural shadows or highlights through aggressive dodging and burning.',
      },
      {
        title: 'Ignoring skin undertones',
        description:
          'Making everyone look orange or pink instead of preserving natural coloring.',
      },
    ],
    restraint: [
    ...
    authorNote:
      'With over 10 years of experience and 500+ weddings edited, our team specializes in bringing out the natural beauty in every photograph.',
  },
